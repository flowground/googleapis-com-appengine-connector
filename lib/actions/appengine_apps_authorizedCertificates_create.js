 ...
 *
 *
 * Operation: 'appengine.apps.authorizedCertificates.create'
 * Endpoint Path: '/v1/apps/{appsId}/authorizedCertificates'
 * Method: 'post'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        ...
        pathName: '/v1/apps/{appsId}/authorizedCertificates',
        method: 'post',
